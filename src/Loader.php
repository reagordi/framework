...
class Loader
{
     ...
     * Если $_SERVER["ML_PERSONAL_ROOT"] не установлен, то личный каталог равен to /medialife/
     *
    ...
    public static function getPersonal($path)
    {
        ...
        $personal = ( isset( $_SERVER["ML_PERSONAL_ROOT"] ) ? $_SERVER["ML_PERSONAL_ROOT"] : "" );
